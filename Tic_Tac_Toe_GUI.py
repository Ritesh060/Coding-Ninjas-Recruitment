...
root = Tk()
root.title("Coding Ninjas Tic Tac Toe")
...
b1 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b1": [which_button(m),buttonclick(b1)])
b2 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b2": [which_button(m),buttonclick(b2)])
b3 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b3": [which_button(m),buttonclick(b3)])
b4 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b4": [which_button(m),buttonclick(b4)])
b5 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b5": [which_button(m),buttonclick(b5)])
b6 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b6": [which_button(m),buttonclick(b6)])
b7 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b7": [which_button(m),buttonclick(b7)])
b8 = Button(root, text= " ", font = ("Arial", 20), height = 3, width= 6 ,bg="Gray", command=lambda m="b8": [which_button(m),buttonclick(b8)])
b9 = Button(root, text= " ", font = ("Arial", 20), height= 3, width= 6 , bg="Gray", command=lambda m="b9": [which_button(m),buttonclick(b9)])
